<template>
    <div class="modal fade" id="importCompetencyModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Import Competency</h1>
...
const submitFile = () => {
    ...
    data.post(route('admin.competencies.import'), {
        forceFormData: true, // Important for file uploads with Inertia
        onSuccess: () => {
            $('#importCompetencyModal').modal('hide');
            // alert('Competencies imported successfully!');
            toastr.success('Competencies imported successfully!');
